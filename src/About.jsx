          ...
          <div className="row justify-content-center">
              ...
              <div className="card h-100 shadow">
                ...
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    Contributed significantly the technical development of our platform with expertise in creating 
                    intuitive and accessible healthcare interfaces.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-3 mb-4">
              <div className="card h-100 shadow">
                ...
                <div className="card-body text-center">
                  <h3 className="card-title">Vaibhav Singh</h3>
                  <p className="card-text">
                  Has been a vital asset to the team ensuring that the efforts of team are well-coordinated. His leadership in task distribution and oversight has been key to maintaining project momentum and achieving our goals efficiently.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-3 mb-4">
              <div className="card h-100 shadow">
                ...
                <div className="card-body text-center">
                  <h3 className="card-title">Monika Singh</h3>
                  <p className="card-text">
                  Has shown exceptional dedication by developing a chatbot that provides users with hospital details and by working on integrating APIs. Her innovative solutions and technical skills have been pivotal to the development of our website.
                  </p>
                </div>
              </div>
            </div>
